...
from open_spiel.python.games import kamisado
...
class KamisadoTest(absltest.TestCase):
  ...
  def test_playthoughs_consistent(self):
    ...
    cc_playthrough = os.path.join(path, "kamisado.txt")
    py_playthrough = os.path.join(path, "python_kamisado.txt")
    ...
    self.assertEqual(
        diffs, {
            ...
            '- GameType.long_name = "Kamisado"\n',
            '+ GameType.long_name = "Python Kamisado"\n',
            '- GameType.short_name = "kamisado"\n',
